...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        categories_json_path = options["categories-json"]
        items_json_path = options["items-json"]
        categories_zip_path = options["categories-zip"]
        items_zip_path = options["items-zip"]
